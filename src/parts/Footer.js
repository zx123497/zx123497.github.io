...
const Footer = (props) => {
  return (
    ...
    >
      ...
      <div style={{}}>
        <h3 style={{ color: "#FFF", marginBottom: "2rem" }}>About website</h3>
        <div style={{ display: "flex", minWidth: "max-content" }}>
          ...
          <div style={{ color: "#ccc", display: "flex", marginLeft: "1rem" }}>
            <h4>花火大會</h4>
          </div>
          <div style={{ color: "#ccc", display: "flex", marginLeft: "1rem" }}>
            <h4>網頁作品專案</h4>
      ...
      <div style={{}}>
        <h3 style={{ color: "#FFF", marginBottom: "2rem" }}>Contact me</h3>
        <div
          style={{
            color: "#FFF",
            display: "flex",
        ...
        <div style={{ color: "#FFF", display: "flex", marginLeft: "1rem" }}>
